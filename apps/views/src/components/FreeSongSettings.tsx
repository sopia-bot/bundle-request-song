...
import { Card, Switch, Input, Button } from '@heroui/react';
...
export const FreeSongSettings = ({
  settings,
  onSettingsChange,
}: FreeSongSettingsProps) => {
  const [freeEnabled, setFreeEnabled] = useState(settings.freeEnabled ?? false);
      ...
      <div className="space-y-6 pl-4 border-l-2 border-gray-200">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <h4 className="text-base font-medium">신청곡 횟수 제한</h4>
            <Switch
